...
def test_payment():
    ...
    assert payment1.authorize() == "Authorizing credit card 1234-5678-9101-1121"
    ...
    assert payment2.send_email_confirmation() == "Sending confirmation email to email@example.com"
